...
list_PRS=c(
  ...
  "Educational attainment (no Brits)"="EA3_excl_23andMe_UK", 
  ...
  "Smoking initiation"="si_substance_use",
  "Smoking cessation"="sc_substance_use",
  "Drinks per week"="dpw_substance_use",
  "Cigarettes per day"="cpd_substance_use",
  "Age at smoking initiation"="ai_substance_use",
	...
	"BMI"="bmi_combined",
	"Body fat"="body_fat",
	"Waist hip ratio" = 'whr_combined',
	"Hip" = "hip_combined",
	"Waist circumference" = "wc_combined",
	"Age at menarche" = "age_at_menarche",
	"Age at menopauze" = "age_at_menopauze" 
)

list_PRS_reg=c(
  "Educational attainment"="EA2_noUKB.residual", 
  "Educational attainment (no Brits)"="EA3_excl_23andMe_UK.residual", 
  "Cognitive ability"="cognitive_ability.residual",
  ...
  "Smoking initiation"="si_substance_use.residual",
  "Smoking cessation"="sc_substance_use.residual",
  "Drinks per week"="dpw_substance_use.residual",
  "Cigarettes per day"="cpd_substance_use.residual",
  "Age at smoking initiation"="ai_substance_use.residual",
  "Cannabis consumption"="cannabis.residual",
  "Caffeine consumption"="caffeine.residual",
  "Coronary artery disease"="coronary_artery_disease.residual",
  "Type II diabetes"="diagram_T2D.residual",
  "Height"="height_combined.residual",
  "BMI"="bmi_combined.residual",
  "Body fat"="body_fat.residual",
  "Waist hip ratio" = 'whr_combined.residual',
  "Hip" = "hip_combined.residual",
  "Waist circumference" = "wc_combined.residual",
  "Age at menarche" = "age_at_menarche.residual",
  "Age at menopauze" = "age_at_menopauze.residual" 
)
